import {
  Component, ViewChild, Input, Output, forwardRef, EventEmitter, ElementRef, Renderer, OnChanges, OnInit
} from '@angular/core';
import { NG_VALUE_ACCESSOR, ControlValueAccessor } from '@angular/forms';
import { NotificationsService } from 'angular2-notifications';
import './upfile.loader.ts';
    ...
    this.qiniuUploader = Qiniu.uploader(Object.assign({
      ...
      init: {
        ...
        'FileUploaded': (up, file, info) => {
          ...
          const data = `https://static.surmon.me'/${JSON.parse(info).key}`;
